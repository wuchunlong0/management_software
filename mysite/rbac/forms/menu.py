...
# 增加图标  http://www.fontawesome.com.cn/faicons/#new
ICON_LIST = [
    ['fa fa-bar-chart', '<i aria-hidden="true" class="fa fa-bar-chart"></i>'],
    ['fa fa-pie-chart', '<i aria-hidden="true" class="fa fa-pie-chart"></i>'],
    ['fa fa-list', '<i aria-hidden="true" class="fa fa-list"></i>'],
    ['fa fa-file', '<i aria-hidden="true" class="fa fa-file"></i>'],
    ['fa fa-copy', '<i aria-hidden="true" class="fa fa-copy"></i>'],
    ['fa fa-paste', '<i aria-hidden="true" class="fa fa-paste"></i>'],
    ['fa fa-upload', '<i aria-hidden="true" class="fa fa-upload"></i>'],
    ['fa fa-download', '<i aria-hidden="true" class="fa fa-download"></i>'],
    ['fa fa-sign-in', '<i aria-hidden="true" class="fa fa-sign-in"></i>'],
    ['fa fa-sign-out', '<i aria-hidden="true" class="fa fa-sign-out"></i>'],
    ['fa fa-sort-alpha-asc', '<i aria-hidden="true" class="fa fa-sort-alpha-asc"></i>'],
    ['fa fa-sort-alpha-desc', '<i aria-hidden="true" class="fa fa-sort-alpha-desc"></i>'],
    ['fa fa-users', '<i aria-hidden="true" class="fa fa-users"></i>'],
    ['fa fa-unlock-alt', '<i aria-hidden="true" class="fa fa-unlock-alt"></i>'],
    ['fa fa-question-circle-o', '<i aria-hidden="true" class="fa fa-question-circle-o"></i>'],
    ['fa fa-search', '<i aria-hidden="true" class="fa fa-search"></i>'],
    ['fa fa-print', '<i aria-hidden="true" class="fa fa-print"></i>'],
    ['fa fa-envelope-o', '<i aria-hidden="true" class="fa fa-envelope-o"></i>'],
    ['fa fa-home', '<i aria-hidden="true" class="fa fa-home"></i>'],
    ['fa fa-lock', '<i aria-hidden="true" class="fa fa-lock"></i>'],
    ['fa fa-handshake-o', '<i aria-hidden="true" class="fa fa-handshake-o"></i>'],
    ['fa fa-save', '<i aria-hidden="true" class="fa fa-save"></i>'],
    ['fa fa-edit', '<i aria-hidden="true" class="fa fa-edit"></i>'],
    ['fa fa-trash-o', '<i aria-hidden="true" class="fa fa-trash-o"></i>'],
    ['fa fa-question-circle-o', '<i aria-hidden="true" class="fa fa-question-circle-o"></i>'],
        
    ['fa fa-university', '<i aria-hidden="true" class="fa fa-university"></i>'],
    ['fa fa-user-circle', '<i aria-hidden="true" class="fa fa-user-circle"></i>'],

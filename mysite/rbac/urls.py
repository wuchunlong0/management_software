...
urlpatterns = [
    ...
    url(r'^user/import/$', user.user_import, name='user_import'), #add
    url(r'^user/tpl/$', user.user_tpl, name='user_tpl'), #add
    ...
    url(r'^menu/permission/add/(?P<second_menu_id>\d+)/$', menu.permission_add, name='menu_permission_add'),
    url(r'^menu/permission/edit/(?P<pk>\d+)/$', menu.permission_edit, name='menu_permission_edit'),
    url(r'^menu/permission/del/(?P<pk>\d+)/$', menu.permission_del, name='menu_permission_del'),

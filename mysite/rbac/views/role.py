...
def role_list(request):
    ...
    roles =[dict(model_to_dict(r),**{'permission' : list(r.permissions.values_list('title', flat=True))}) for r in role_all]
    return render(request, 'rbac/role_list.html', context=locals())

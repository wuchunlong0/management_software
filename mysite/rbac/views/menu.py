...
def menu_list(request):
    ...
    if second_menu_id:
        ...
        permissions = []
    return render(request, 'rbac/menu_list.html', context=locals()) 
...
def second_menu_del(request, pk):
    ...
    url = memory_reverse(request, 'rbac:menu_list')
    if request.method == 'GET':
        return render(request, 'rbac/user_del.html', {'cancel': url})
...
def multi_permissions(request):
    ...
    return render(request, 'rbac/multi_permissions.html', context=locals())
...
def distribute_permissions(request):
    ...
    #print('user_has_permissions====', list(user_has_permissions))
    #print('user_has_permissions_dict====',user_has_permissions_dict)
    ...
    """
    return render(request, 'rbac/distribute_permissions.html', context=locals())
